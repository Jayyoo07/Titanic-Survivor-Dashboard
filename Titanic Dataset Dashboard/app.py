...
#  HEADER
st.markdown("# 🚢 RMS Titanic — Survival Analytics Dashboard")
st.markdown(
    "<p style='font-size:17px; color:#5A6B7B; margin-top:-10px;'>"
    "An interactive look at <b>who survived</b> the night of <b>April 14–15, 1912</b> — and why."
    "</p>",
    unsafe_allow_html=True,
)
st.markdown("---")
...
<div class="insight-box">
  ...
  but it was unevenly enforced across decks. Class privilege, not heroism,
  was the strongest single predictor of who walked off the lifeboats.</p>
</div>
""", unsafe_allow_html=True)
...
<div class="footer">
  <b>Data source:</b>
  <a href="https://www.kaggle.com/competitions/titanic/data" target="_blank">
  ...
  Dashboard built with Python · Streamlit · Plotly · Pandas — for educational use.
</div>
""", unsafe_allow_html=True)
