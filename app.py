...
<style>
  ...
  section[data-testid="stSidebar"] { background: #0B2545 !important; border-right: 3px solid #E8B04B; }
...
with st.sidebar:
    ...
    st.caption("Every chart updates instantly when you change a filter.")
    st.markdown("---")
    ...
    st.markdown("---")
    st.caption("Tip: filter to Female + First Class, then Male + Third Class to see the biggest survival gap.")
